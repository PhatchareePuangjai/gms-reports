                          ...
                          {() => (
                            ...
                            >
                              ...
                              <option value="ค่าอาหารค่าอาหารว่างและค่าเครื่องดื่ม ค่าเดินทาง">
                                ค่าอาหารค่าอาหารว่างและค่าเครื่องดื่ม ค่าเดินทาง
                              </option>
                              <option value="เงินสนับสนุนโครงการ ค่าเช่าอุปกรณ์โสตทัศนูปกรณ์">
                                เงินสนับสนุนโครงการ ค่าเช่าอุปกรณ์โสตทัศนูปกรณ์
                              </option>
                            </select>
                          )}
                        </Observer>
                        ...
                        <Observer>
                          {() => (
                            <input
                              type="number"
                              value={
                                paymentPeriod.balanceForward?.bankWithdrawal ||
                                ""
                              }
                              disabled
                            />
                        ...
                        <Observer>
                          {() => (
                            <input
                              type="number"
                              value={
                                paymentPeriod.balanceForward?.bankRemaining ||
                                ""
                              }
                              disabled
                            />
                        ...
                        <Observer>
                          {() => (
                            <input
                              type="number"
                              value={
                                paymentPeriod.balanceForward?.cashRemaining ||
                                ""
                              }
                              disabled
                            />
                        ...
                        <Observer>
                          {() => (
                            <input
                              type="number"
                              value={
                                paymentPeriod.balanceForward?.withholdingTax ||
                                ""
                              }
                              disabled
                            />
                      ...
                      <td>
                        <Observer>
                          {() => (
                            <input
                              type="text"
                              value={paymentPeriod.balanceForward?.remark || ""}
                              disabled
                            />
                          )}
                        </Observer>
                                ...
                                <td>
                                  <Observer>
                                    {() => (
                                      <input
                                        type="number"
                                        value={row.bankRemaining || ""}
                                        onChange={(e) =>
                                          row.setBankRemaining(
                                            Number(e.currentTarget.value)
                                          )
                                        }
                                      />
                                ...
                                <td>
                                  <Observer>
                                    {() => (
                                      <input
                                        type="number"
                                        value={row.cashRemaining || ""}
                                        onChange={(e) =>
                                          row.setCashRemaining(
                                            Number(e.currentTarget.value)
                                          )
                                        }
                                      />
